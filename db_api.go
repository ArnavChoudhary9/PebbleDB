...
// EXAMPLE STRUCTS AND USAGE

// User struct for demonstration
// type User struct {
//     ID        int64     `db:"id" primary:"true" auto:"true"`
//     Name      string    `db:"name" notnull:"true"`
//     Email     string    `db:"email" unique:"true" notnull:"true"`
//     Age       int       `db:"age"`
...
//     ID          int64   `db:"id" primary:"true" auto:"true"`
//     Name        string  `db:"name" notnull:"true"`
//     Price       float64 `db:"price" notnull:"true"`
//     Description string  `db:"description"`
//     InStock     bool    `db:"in_stock" default:"1"`
// }

// // ExampleUsage demonstrates both struct-based and map-based operations
// func ExampleUsage() {
...
//     err = db.CreateTableFromStruct("users", User{})
//     if err != nil {
//         log.Fatal("Failed to create users table:", err)
//     }

//     err = db.CreateTableFromStruct("products", Product{})
//     if err != nil {
...
//     userID, err := db.InsertStruct("users", &user)
//     if err != nil {
...
//     // Select structs
//     var users []User
//     err = db.SelectStruct("users", &users, "age > ?", 25)
//     if err != nil {
//         log.Fatal("Failed to select users:", err)
//     }
//     fmt.Printf("Found %d users over 25\n", len(users))

//     // Also supports original map-based operations
...
//     id, err := db.Insert("users", userData)
//     if err != nil {
//         log.Fatal("Failed to insert user:", err)
//     }
//     fmt.Printf("Inserted user with ID: %d\n", id)
